...
import { UserCog, Mail, Lock, User, Shield, BellRing } from "lucide-react";
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="md:col-span-1">
              <div className="space-y-1">
                <Button variant="ghost" className="w-full justify-start bg-[#74d1ea]/10 text-[#74d1ea]">
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-gray-300">Content Updates</p>
                            <p className="text-gray-500 text-sm">Receive notifications when your content is updated</p>
                          </div>
                          <Switch defaultChecked />
                        </div>
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-gray-300">New Features</p>
                            <p className="text-gray-500 text-sm">Get notified about new features and improvements</p>
                          </div>
                          <Switch defaultChecked />
                        </div>
                      </div>
