              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-gray-900/30 rounded-lg p-6 border border-gray-700/60">
                  ...
                  <ul className="space-y-3 mb-4">
                    ...
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-[#74d1ea] mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-300">Product demo materials</span>
                    </li>
                    <li className="flex items-start">
                      <CheckCircle className="h-5 w-5 text-[#74d1ea] mr-2 mt-0.5 flex-shrink-0" />
                      <span className="text-gray-300">Early adopter promotions</span>
                    </li>
                  </ul>
                  <p className="text-gray-400 text-sm italic">Perfect for: Businesses launching new products or significant feature updates</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="py-16 bg-black">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h2 className="text-3xl font-semibold text-white mb-6">Ready to Streamline Your Marketing Campaigns?</h2>
